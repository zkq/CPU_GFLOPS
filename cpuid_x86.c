...
int main()
{
    ...
    if (cpuid_x86_support(_CPUID_X86_FMA_))
    {
        ...
        printf("gcc -pthread -O3 -D_USE_X86_FMA -c cpufp.c\n");
        printf("gcc -pthread -O3 -o cpufp_x86 smtl.o cpufp.o cpufp_x86_fma.o\n");
    }
    else if (cpuid_x86_support(_CPUID_X86_AVX_))
    {
        printf("as -o cpufp_x86_avx.o cpufp_x86_avx.s\n");
        printf("gcc -pthread -O3 -D_USE_X86_AVX -c cpufp.c\n");
        printf("gcc -pthread -O3 -o cpufp_x86 smtl.o cpufp.o cpufp_x86_avx.o\n");
    }
    else if (cpuid_x86_support(_CPUID_X86_SSE2_))
    {
        printf("as -o cpufp_x86_sse.o cpufp_x86_sse.s\n");
        printf("gcc -pthread -O3 -D_USE_X86_SSE -c cpufp.c\n");
        printf("gcc -pthread -O3 -o cpufp_x86 smtl.o cpufp.o cpufp_x86_sse.o\n");
    }
